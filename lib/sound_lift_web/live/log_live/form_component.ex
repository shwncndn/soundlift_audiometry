defmodule SoundLiftWeb.LogLive.FormComponent do
  use SoundLiftWeb, :live_component
  ...
  def render(assigns) do
    ...
    <div>
      ...
      <.simple_form
        ...
        phx-submit="save"
      >
        <.input field={@form[:left_ear]} type="number" label="Left ear" />
        <.input field={@form[:right_ear]} type="number" label="Right ear" />
